...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (appProvider.isListening && !_micAnimationController.isCompleted) {
        ...
        actions: [
          ...
          if (appProvider.messages.isNotEmpty)
            IconButton(
              ...
              onPressed: () {
                _showSummaryDialog(context, appProvider);
              },
          ...
          if (appProvider.messages.isNotEmpty)
            IconButton(
              ...
              onPressed: () {
                _showClearConfirmationDialog(context, appProvider);
              },
          ...
          IconButton(
            icon: Icon(
              appProvider.bypassTranslation ? Icons.language : Icons.translate,
              color: Theme.of(context).colorScheme.primary,
            ),
            onPressed: () {
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  color: appProvider.isConnected ? Colors.white : Colors.red,
                ),
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            onSubmitted: (text) {
                              if (text.isNotEmpty) {
                                appProvider.processTextInput(text);
            ...
            children: List.generate(10, (index) {
              ...
              final height =
                  ...
                  40 *
                      math
                          .sin(
                            (_waveformAnimationController.value * math.pi * 2) +
                                (index / 3),
                          )
                          .abs();
  ...
  Widget _buildMessageBubble(
    ...
    final bool isErrorMessage =
        isError || (message.startsWith('(') && message.endsWith(')'));
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    if (!isErrorMessage && isDirectMode) ...[
                      const SizedBox(width: 8),
                      Container(
                    ...
                    // Sentiment indicator
                    if (!isErrorMessage && isUser && sentiment != null) ...[
                      const SizedBox(width: 8),
                      Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 6,
                    ...
                    if (!isUser && !isErrorMessage)
                      InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Icon(
                            Provider.of<AppProvider>(context).isReplying
                                ? Icons.stop
                                : Icons.volume_up,
                            size: 22,
                            color: Theme.of(
              ...
              OutlinedButton.icon(
                ...
                onPressed: () {
                  ...
                  showDialog(
                    ...
                    builder:
                        (context) => AlertDialog(
                          title: const Text('Speech Recognition Tips'),
                          content: SingleChildScrollView(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisSize: MainAxisSize.min,
                              children: const [
                                Text('To improve speech recognition:'),
                                SizedBox(height: 8),
                                Text(
  ...
  void _showEditDialog(String originalMessage) {
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  ...
                  if (editedText.isNotEmpty && editedText != originalMessage) {
  ...
  // Show summary dialog
  void _showSummaryDialog(BuildContext context, AppProvider appProvider) async {
    // Create the Future outside of the dialog build
    final Future<String> summaryFuture = appProvider.summarizeConversation();
                ...
                children: [
                  ...
                  Flexible(
                    child: FutureBuilder<String>(
                      future: summaryFuture, // Use the pre-created Future
